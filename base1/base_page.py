...
class BasePage:
    ...
    def locator_element(self,loc):
        try:
            ...
            self.get_screenshot_as_png('定位失败')
            raise
        else:
    ...
    def click(self,loc):
        try:
            ...
            self.get_screenshot_as_png('元素不可点击')
    ...
    def clear_text(self, loc):
        ...
        try:
            ...
            self.get_screenshot_as_png('清除文本内容')
    ...
    def send_keys(self,loc,key):
        try:
            ...
            self.get_screenshot_as_png('输入文本框值失败')
    ...
    def clear_send_keys(self,loc,key):
        try:
            ...
            self.get_screenshot_as_png('清除并输入文本框值失败')
            log.logger.exception(str(loc)+"元素输入框，无法输入值",exc_info=True)
            raise
        else:
            log.logger.info("[%s]元素输入框，输入值[%s]" % (str(loc),key))
    ...
    def goto_url(self,url):
        try:
            ...
            self.get_screenshot_as_png('打开url失败')
    ...
    def get_text(self,loc):
        try:
            ...
            self.get_screenshot_as_png('获取文本失败')
    ...
    def move_to_element(self,loc):
        action=self.actionChains()
        action.move_to_element(self.locator_element(loc)).perform()
    ...
    def element_to_be_clickable(self,loc):
        try:
            ...
            self.get_screenshot_as_png('元素不可操作')
    ...
    def is_visible_text(self,loc):
        try:
            ...
            self.get_screenshot_as_png('元素不可见')
        else:
    ...
    def is_visible(self,loc):
        try:
            ...
            self.get_screenshot_as_png('元素未出现')
            return False
        else:
    ...
    def is_not_visible(self,loc,timeout):
        try:
            ...
            self.get_screenshot_as_png('元素未消失')
            return False
        else:
    ...
    #失败用例截图
    def get_screenshot_as_png(self,screenshot_name):
        img=self.driver.get_screenshot_as_png()
        allure.attach(img, screenshot_name, allure.attachment_type.PNG)
    ...
    def assertEqual(self,expectation,actual):
        ...
        try:
            ...
            self.get_screenshot_as_png('断言失败')
